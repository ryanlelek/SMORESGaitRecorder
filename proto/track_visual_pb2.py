...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='gazebo.msgs',
  serialized_pb='\n\x12track_visual.proto\x12\x0bgazebo.msgs\"\\\n\x0bTrackVisual\x12\x0c\n\x04name\x18\x01 \x02(\t\x12\x1b\n\x13inherit_orientation\x18\x02 \x01(\x08\x12\x10\n\x08min_dist\x18\x03 \x01(\x01\x12\x10\n\x08max_dist\x18\x04 \x01(\x01')
...
_TRACKVISUAL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='inherit_orientation', full_name='gazebo.msgs.TrackVisual.inherit_orientation', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='min_dist', full_name='gazebo.msgs.TrackVisual.min_dist', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='max_dist', full_name='gazebo.msgs.TrackVisual.max_dist', index=3,
